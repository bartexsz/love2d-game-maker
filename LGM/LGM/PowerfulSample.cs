//Love Game Maker Script Editor
//By Radfordhound
//Built using "FastColoredTextBox".
using System;
...
namespace LGM
{
    public partial class PowerfulSample : Form
    {
        ...
        {
            InitializeComponent();
            this.FormClosing += PowerfulSample_FormClosing;
        }
        ...
        void savescript()
        {
            //Saves the script before closing.
        }
        ...
        private void startStopMacroRecordingToolStripMenuItem1_Click(object sender, EventArgs e)
        {
