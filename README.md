...
And this is the minimum code with next to no un-needed functions! This doesn't even include adding the spritefont used by this code to actually draw the text to the screen! You need to create one, as without it Monogame will simply error upon attempting to compile this.

Now, comparing the above to other languages like C, you'd probably call me an insane man for even attempting to say MonoGame is difficult. Considering how much MonoGame handles for you, I'd be crazy to say it WASN'T easy.
...
This is where LÖVE 2D comes into play. As previously mentioned, LÖVE 2D games are written using Lua. As a programmer who's used many different languages (VB.Net,C,C++,C#,Java,Lua,Batch, and *cough*GML*cough*.), I can easily say that Lua is one of, if not the easiest programming language I've ever used for many, many reasons. This makes the engine alot easier for new programmers to use, as well as speeding things up drastically for experienced programmers without limiting their potential!
...
Well, that's just it. LÖVE 2D doesn't use a compiler! Instead, user's code is run using the engine's executable itself, similar to Java. Unlike Java, however, is the fact that code runs surprisingly fast in LÖVE 2D, to the point where there's hardly even a difference in the speed at which your code runs in LÖVE 2D vs. a compiled game engine!
...
The point I'm trying to make here is that people are scared of the word "code"! Programmers have always been portrayed in media as nerdy geniuses who understand absolutely everything their is to know about the world. Because of this, many people think they can't code because they're "not a programmer", as in "not a genius", and won't even give it a try. What's silly about this is that TRYING IS HOW YOU LEARN!!!

So, why Love Game Maker? Do you think Love Game Maker will be an advanced coding tool to help people accurately emulate the human brain using nothing but an Intel Celeron? (Tech guys who were stuck with old laptops for ages will get that joke. ;) ) 
...
I wasn't trapped in a room being forced to listen to a boring seminar on the ways of coding. I wasn't even given an easy-peasy guide on how coding works. Instead I was given tools to keep me from doing any actual coding, and just doing what I wanted in the first place: Making games. So how, then, did Game Maker teach me the principle of coding? Quite simply, It didn't! It laid the foundation for easy drag-n-drop game creation, gave me some handy examples, and said "There ya' go! Enjoy!", leaving me clue-less, but intrigued. Sparking that desire to learn deep within me more than anything else I've ever used before. I was still in the awkward-but-normal stage of wanting to make games, but being scared of coding. But I wasn't coding! I was making games! This eliminated the fear aspect and simply left me to do the work I wanted to acomplish in the first place.
...
Of course, if I needed help, tutorials were avaliable. Lots of them. In fact, there were so many of them that I still am un-able to count them! But it didn't force me through these tutorials. Rather, it provided them if I needed them and simply said "Figure it out!". This not only inspired me to make games, but learn the software so I'd better understand it and, in turn, be able to make better games. It let me play with my imagination in an easy ans secure environment, skipping all the boring tutorials no one wants to hear. And whenever I came crying back to Game Maker's arms, it was there for me with full, simple, but excellent documentation right at my fingertips for absolutely everything I could possibly want to know. Not even included the previously-mentioned multitude of tutorials made by the community!
...
So, one day, when I was experienced enough with the software and confident enough, I decided to try out GML. Slowly but sure-ly I learned it, and without much trouble as the language is designed to let you make mistakes. (Such as not requiring you to declare variables or end your lines with semi-colons.) And before you know it, I wasn't scared of coding!
...
Several projects have already been started to attempt to teach kids to code. Such as the excellent Scratch project (https://scratch.mit.edu/). But, unfortunately, most of these projects have either had little-to-no effort put into them (Such as Microsoft's "Small Basic" project, or "Kodu Game Lab", both of which they kind of made and then promptly abandoned.), or had lots of effort but are designed to be "too easy" (Such as Scratch), limiting your potential to what that engine can do, and nothing more.
...
Definitely! While I'm confident enough in my skills to pull this off, I doubt I'll be able to do it well enough to meet the goals of the project without help from you! That's why this project's on GitHub! So you can contribute your awesome talents!
...
Are you a good leader? Prove your worth by helping out in any way possible, and I may just make you an administrator over the project/site/forum! Do you have something you're willing to donate for the project? (Such as money, servers, blood, etc. *Just kidding about the blood thing.*) We'd very much appreticate that! Are you popular? Spread the news! We need as much help as we can get!
...
And you'll all by credited, of course. *-Duh!-*

#What's the license for the project?

The license will be detailled in the license.txt file. (That is... once you epic laywers come out and help me write it! :|)
But, generally, you're free to do whatever with the source except

A: Sell it.
B: Claim it as your own.
C: Change this license, or any licenses included with the project.
D: Break any of the licenses included with the project. Of course. :P

THIS IS NOT THE FULL LICENSE!!! It will be detailled within the license.txt file. Please check it out if you need specific details. We'll try to make it simple. ;) Thanks!
...
If you notice something that's "off" and are pretty sure I'm un-aware of it, submit an "issue" about the specific file in question, and I'll respond as quickly as I can.
